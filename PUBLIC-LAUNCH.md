...
4. **决策状态**：D1/D2/D3/D5/D6/D7 已定。收益分配具体细则生效前，不构成任何既得收益分配承诺。
...
| `02-co-creation/contribution-pool-design.md` | 收益分配机制设计（概念稿，具体比例/方向待商业化启动再定） |
...
| `06-hub/README.md` | HU扩展目录说明（后期非根前端文件） |
