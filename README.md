...
| 文档 | 说明 |
|---|---|
| [`co-creation/creator-management-system_v1.md`](co-creation/creator-management-system_v1.md) | **运营体系主档**（OWKV-CREATOR-SYS v2.0）：一个 Hub + 平台矩阵入口、同一事实源、决策表（D1-D7）、共创流水线、积分看板、公示四档 |
