...
| 文档 | 说明 |
|---|---|
| [`creator-management-system_v1.md`](creator-management-system_v1.md) | **运营体系主档**（OWKV-CREATOR-SYS v2.0）：一个 Hub + 平台矩阵入口、同一事实源、决策表（D1-D7）、共创流水线、积分看板、公示四档；Hub 门面站与平台矩阵的管理中枢 |
...
| [`hub-frontend-plan_v1.md`](hub-frontend-plan_v1.md) | 前端入口（Hub 门面站）规划（OWKV-HUB-FRONTEND-v2）：统一门面，GitHub Pages 起步零成本，备案仅作加速层可选；v2 重写替代原备案站大规划 |
